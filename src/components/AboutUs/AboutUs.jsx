      ...
      <Container>
        <Row className='pt-5 mt-5 mb-5'>
          <Col xs={12} md={12} lg={12} className='text-center'>
            <p className='title-mtech'>M-Tech 2024</p>
          </Col>
        </Row>
        <Row>
      ...
      <Container className='my-5'>
        <Row>
          ...
          <Col xs={12} md={6} lg={6} className='cont-text-bot text-center py-4 px-5' data-aos='fade-zoom-in' data-aos-easing='ease-in-back' data-aos-delay='200' data-aos-offset='0' data-aos-duration='1000'>
            <div>
              <p>Entonces</p> <br />
              <h2 className='title-bot'> ¡M-Tech 2024 es para ti!</h2><br />
        ...
        <Row>
          ...
          >
            <p>
              Las categorías de M-Tech 2024 te permitirán sobrepasar los límites de tu imaginación, poner a prueba tus habilidades en robótica, crear innovaciones y potenciar tus habilidades blandas
            </p>
          </Col>
